package src.test.java.com.example.speakingclock;
...
import com.example.speakingclock.SpeakingClock1Application;

import static org.junit.jupiter.api.Assertions.assertEquals;

@SpringBootTest(classes = SpeakingClock1Application.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class SpeakingClock1ApplicationTests {
